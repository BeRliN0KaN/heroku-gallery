      ...
      <div class="row">
        ...
        ?>
          <div class="rounded-4 service-item text-center p-4 flex-column align-items-center mt-5">
            ...
            <br>
            <?php
            // ถ้ามีข้อมูลลิงก์ (ไม่เป็นค่าว่าง) ให้แสดงปุ่ม Read More
            if (!empty($activity_link_url)) {
            ?>
              <div>
                <a href="<?php echo htmlspecialchars($activity_link_url); ?>">
                  <button class="btn btn-link">Read More</button>
                </a>
              </div>
            <?php } // จบเงื่อนไขตรวจลิงก์ 
            ?>
